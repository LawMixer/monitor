...
pub struct Env {
  ...
  /// Override `allow_unauthenticated_reads`
  pub monitor_allow_unauthenticated_reads: Option<bool>,
...
pub struct CoreConfig {
  ...
  /// Users can make read requests without providing credentials.
  #[serde(default)]
...
impl CoreConfig {
  pub fn sanitized(&self) -> CoreConfig {
    ...
    CoreConfig {
      ...
      allow_unauthenticated_reads: config.allow_unauthenticated_reads,
